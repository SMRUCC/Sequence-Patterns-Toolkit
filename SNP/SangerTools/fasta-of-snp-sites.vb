Public NotInheritable Class GlobalMembersFastaMinusofMinussnpMinussites
	Private Sub New()
	End Sub
	'
...
'	 
	...
	Public Shared Sub create_fasta_of_snp_sites(ByRef filename As String, number_of_snps As Integer, ByRef bases_for_snps As String(), ByRef sequence_names As String(), number_of_samples As Integer, output_reference As Integer, _
